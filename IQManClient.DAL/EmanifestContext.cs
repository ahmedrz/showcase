namespace IQManClient.DAL
{
    ...
    using System.Linq;
    using IQManClient.DAL.Migrations;
    ...
    public partial class EmanifestContext : DbContext
    {
        ...
        {
            //modelBuilder.Entity<BOLDetails>()
            //      .HasMany(x => x.ConsignmentDetails)
            //     .WithOptional(con => con.BOLDetails)
            //     .WillCascadeOnDelete();
            //modelBuilder.Entity<BOLDetails>()
            //     .HasMany(x => x.ContainerDetails)
            //    .WithRequired(ctr => ctr.BOLDetails)
            //    .WillCascadeOnDelete();
            //modelBuilder.Entity<ContainerDetails>()
            //    .HasMany(x => x.ConsignmentDetails)
            //   .WithOptional(con => con.ContainerDetails)
            //   .WillCascadeOnDelete();
            //modelBuilder.Entity<ConsignmentDetails>()
            //    .HasMany(x => x.VehicleDetails)
            //   .WithRequired(veh => veh.ConsignmentDetails)
            //   .WillCascadeOnDelete();
