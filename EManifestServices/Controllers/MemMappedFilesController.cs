...
{
    [BasicAuthentication]
    [System.Web.Http.Authorize(Roles = "Admin,IQManClient")]
    public class MemMappedFilesController : ApiController
    {
        ...
        public HttpResponseMessage Get(string fileName)
        {
            ...
            using (mmf)
            {
                Stream stream
                    ...
                    ? mmf.CreateViewStream(contentInfo.From, contentInfo.Length - 1, MemoryMappedFileAccess.Read)
        ...
        {
            return String.Format("Global\\{0}_{1}", MapNamePrefix, fileName);
        }
    }
}
