...
namespace EManifestServices.DAL.Enums
{
    public class Sources
    {
        ...
        public List<ComboItemSource> ContainerOwnerTypes { get; set; }
        public Sources()
        {
            ...
            ContainerOwnerTypes=enums.containerOwnerTypes.Select(i => new ComboItemSource { Value = i.Key, Text = $"{i.Key} - {i.Value.ToString()}" }).ToList();
            FillImoClasses();
        }
