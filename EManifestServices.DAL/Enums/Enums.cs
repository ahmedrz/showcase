...
namespace EManifestServices.DAL.Enums
{
    ...
    public enum ContainerOwnerTypes
    {
        CarrierOwnedContainer,
    ...
    public class EnumsHelper
    {
        ...
        public Dictionary<string, ContainerOwnerTypes> containerOwnerTypes;
        public EnumsHelper()
        {
            ...
            containerOwnerTypes = new Dictionary<string, ContainerOwnerTypes>();
            containerOwnerTypes.Add("COC", ContainerOwnerTypes.CarrierOwnedContainer);
            containerOwnerTypes.Add("SOC", ContainerOwnerTypes.ShipperOwnedContainer);
